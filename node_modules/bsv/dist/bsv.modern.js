    ...
    if (fExec && opCodeNum >= 0 && opCodeNum <= OpCode.OP_PUSHDATA4) {
      ...
      switch (opCodeNum) {
        ...
        case OpCode.OP_16:
          {
            ...
            let _buf = new Bn(n).toScriptNumBuffer();
        ...
        case OpCode.OP_VERIFY:
          {
            ...
            let _buf3 = this.stack[this.stack.length - 1];
            let fValue = Interp.castToBool(_buf3);
        ...
        case OpCode.OP_2DUP:
          {
            ...
            let _buf4 = this.stack[this.stack.length - 2];
            let _buf5 = this.stack[this.stack.length - 1];
        ...
        case OpCode.OP_3DUP:
          {
            ...
            let _buf6 = this.stack[this.stack.length - 3];
            let _buf7 = this.stack[this.stack.length - 2];
        ...
        case OpCode.OP_2OVER:
          {
            ...
            let _buf8 = this.stack[this.stack.length - 4];
            let _buf9 = this.stack[this.stack.length - 3];
        ...
        case OpCode.OP_IFDUP:
          {
            ...
            let _buf10 = this.stack[this.stack.length - 1];
            let fValue = Interp.castToBool(_buf10);
        ...
        case OpCode.OP_DEPTH:
          {
            let _buf11 = new Bn(this.stack.length).toScriptNumBuffer();
        ...
        case OpCode.OP_ROLL:
          {
            ...
            let _buf12 = this.stack[this.stack.length - 1];
            let bn = new Bn().fromScriptNumBuffer(_buf12, fRequireMinimal);
            let n = bn.toNumber();
            this.stack.pop();
            ...
            _buf12 = this.stack[this.stack.length - n - 1];
        ...
        case OpCode.OP_RSHIFT:
          {
            ...
            let _buf13 = this.stack[this.stack.length - 2];
            let value = new Bn(_buf13);
            ...
            let _buf14 = value.toBuffer().slice(-_buf13.length);

            if (_buf14.length < _buf13.length) {
              _buf14 = Buffer.concat([Buffer.alloc(_buf13.length - _buf14.length), _buf14]);
            }
        ...
        case OpCode.OP_EQUALVERIFY:
          {
            ...
            let _buf15 = this.stack[this.stack.length - 2];
            let _buf16 = this.stack[this.stack.length - 1];
            let fEqual = cmp(_buf15, _buf16);
            this.stack.pop();
            this.stack.pop();
        ...
        case OpCode.OP_0NOTEQUAL:
          {
            ...
            let _buf17 = this.stack[this.stack.length - 1];
            let bn = new Bn().fromScriptNumBuffer(_buf17, fRequireMinimal);
        ...
        case OpCode.OP_HASH256:
          {
            ...
            let _buf18 = this.stack[this.stack.length - 1];
            let bufHash;

            if (opCodeNum === OpCode.OP_RIPEMD160) {
              bufHash = Hash.ripemd160(_buf18);
            } else if (opCodeNum === OpCode.OP_SHA1) {
              bufHash = Hash.sha1(_buf18);
            } else if (opCodeNum === OpCode.OP_SHA256) {
              bufHash = Hash.sha256(_buf18);
            } else if (opCodeNum === OpCode.OP_HASH160) {
              bufHash = Hash.sha256Ripemd160(_buf18);
            } else if (opCodeNum === OpCode.OP_HASH256) {
              bufHash = Hash.sha256Sha256(_buf18);
            }
...
export { Ach, Address, Aes, Aescbc, Base58, Base58Check, Bip32, Bip39, Block, BlockHeader, Bn, Br, Bsm, Bw, Cbc, Constants, Ecdsa, Ecies, Hash, Interp, KeyPair, OpCode, Point, PrivKey, PubKey, Random, Script, Sig, SigOperations, Struct, Tx, TxBuilder, TxIn, TxOut, TxOutMap, TxVerifier, VarInt, Workers, WorkersResult, cmp, deps, wordList as en, getConstants, wordList$1 as jp, version };
